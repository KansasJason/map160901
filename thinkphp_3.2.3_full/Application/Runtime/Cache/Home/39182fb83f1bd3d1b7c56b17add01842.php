...
<div class="info">
    ...
    <span class="avatar"><img src=""><span class="welcome"><b></b><i>欢迎您~</i></span></span>
    <div class="change"><a href="<?php echo U('Index/reviseinfo');?>">点击修改个人信息</a></div>
    <div class="back"><a href="<?php echo U('Index/back');?>">退出</a></div>
</div>
<div id="container">
    ...
    window.onload = function () {
        $.get("<?php echo U('Index/getimg');?>").then(function (res) {
            if (res.status == 0) {
                ...
                $('.welcome b').html(res.msg);
            } else {
                $('.avatar img').attr('src', '/Application/Home/View/load.jpg');
            }
        });
    }
...
<div style="display: none;">
    ...
    <input type="text" name="message_id" id="m_id"></div>
